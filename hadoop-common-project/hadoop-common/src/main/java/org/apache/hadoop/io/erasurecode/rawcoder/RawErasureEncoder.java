...
public abstract class RawErasureEncoder {
  ...
  private static OurECLogger ourlog = OurECLogger.getLogger(RawErasureEncoder.class);
  ...
  public void encode(ByteBuffer[] inputs, ByteBuffer[] outputs)
    ...
    ByteBufferEncodingState bbeState = new ByteBufferEncodingState(
        this, inputs, outputs);
    ourlog.write("\n Inside RawErasureEncoder: inside encode method for ByteBuffer[]");
  ...
  public void encode(byte[][] inputs, byte[][] outputs) throws IOException {
    ByteArrayEncodingState baeState = new ByteArrayEncodingState(
        this, inputs, outputs);
    ourlog.write("\n Inside RawErasureEncoder: inside encode method for byte[][]");
  ...
  public void encode(ECChunk[] inputs, ECChunk[] outputs) throws IOException {
    ...
    ourlog.write("\n Inside RawErasureEncoder: inside encode method for ECChunk[]");
