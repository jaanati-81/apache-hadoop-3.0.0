...
class StripedReader {
  ...
  private static OurECLogger ourlog = OurECLogger.getLogger(StripedReader.class);
  ...
  void init() throws IOException {
    ...
    initZeroStrip();
    ourlog.write("\n In StripedReader, after init() call.. Initilaized readers, buffersize and zerostrip");
  }
