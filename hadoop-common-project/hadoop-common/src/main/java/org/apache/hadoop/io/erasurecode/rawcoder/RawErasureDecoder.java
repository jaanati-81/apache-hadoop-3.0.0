...
public abstract class RawErasureDecoder {
  ...
  private static OurECLogger ourlog = OurECLogger.getLogger(RawErasureDecoder.class);
  ...
  public void decode(ByteBuffer[] inputs, int[] erasedIndexes,
    ...
    if (usingDirectBuffer) {
      ...
      doDecode(badState); //calls real implementation in the Decoder class (here its abstract)
    }
  ...
  public void decode(byte[][] inputs, int[] erasedIndexes, byte[][] outputs)
    ...
    ByteArrayDecodingState decodingState = new ByteArrayDecodingState(this,
        inputs, erasedIndexes, outputs);
    ourlog.write("\n Inside RawErasureDecoder: inside decode method for byte[][]");
  ...
  public void decode(ECChunk[] inputs, int[] erasedIndexes,
    ...
    ourlog.write("\n Inside RawErasureDecoder: inside decode method for ECChunk[]");
