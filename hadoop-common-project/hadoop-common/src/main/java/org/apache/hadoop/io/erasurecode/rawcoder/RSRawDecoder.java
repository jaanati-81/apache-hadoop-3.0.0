...
public class RSRawDecoder extends RawErasureDecoder {
  ...
  private static OurECLogger ourlog = OurECLogger.getLogger(RSRawDecoder.class);
  ...
  public RSRawDecoder(ErasureCoderOptions coderOptions) {
    ...
    //ourlog.write("\n Inside RSRawDecoder: computed encodeMatrix (Cauchy)..");
    if (allowVerboseDump()) {
  ...
  private void processErasures(int[] erasedIndexes) {
    ...
    ourlog.write("\n Inside RSRawDecoder: in processErasures, calling generateDecodeMatrix...");
